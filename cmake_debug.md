...
4. Чистка: Если что-то "глючит", всегда используйте команду Ctrl+Shift+P -> CMake: Delete Cache and Reconfigure. Это лечит 90% проблем.

5. Если что-то пошло не так (Чек-лист исправлений):
      ...
      -Глюки конфигурации: Ctrl + Shift + P -> CMake: Delete Cache and Reconfigure. Это универсальное решение, если VS Code "затупил".
